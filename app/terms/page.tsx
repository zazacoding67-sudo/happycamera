  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
      ...
      <div className="prose prose-sm prose-neutral max-w-none text-[#666] leading-relaxed space-y-4">
        <p>All prices are in USD and include applicable taxes unless stated otherwise.</p>
        <p>Payment must be received in full before an order is processed. We accept payments via Toyyibpay (FPX, e-wallet, and card).</p>
