  ...
  return (
    ...
    >
      {mounted ? (
        <>
          <motion.div
            className="absolute top-0 -bottom-[12%] inset-x-0 md:inset-0 overflow-hidden"
            style={{ y: parallaxY, willChange: "transform" }}
          >
            <motion.div
              className="absolute inset-0"
              initial={noHide ? false : { scale: 1.05 * 1.15 }}
        ...
        {mounted ? (
          <>
            <motion.p
              ...
              className="text-[9px] md:text-[11px] tracking-[0.3em] uppercase text-yellow-400 font-medium mb-2 md:mb-4"
            >
              Ready to shoot?
            </motion.p>
            <motion.h2
              ...
              className="text-[clamp(1.15rem,5vw,5rem)] md:text-[clamp(2rem,6vw,5rem)] font-bold tracking-tight text-white leading-[1.1]"
            >
            ...
            >
              <Link
                href="/shop"
                className="inline-flex items-center justify-center px-5 py-2 md:px-8 md:py-4 text-[10px] md:text-sm font-semibold tracking-wider uppercase bg-yellow-400 text-black rounded-none hover:bg-yellow-300 min-w-[170px] md:min-w-[220px] transition-all"
              >
                Browse All Cameras
              </Link>
            </motion.div>
          ...
          <>
            <p className="text-[9px] md:text-[11px] tracking-[0.3em] uppercase text-yellow-400 font-medium mb-2 md:mb-4">
              Ready to shoot?
            </p>
            <h2 className="text-[clamp(1.15rem,5vw,5rem)] md:text-[clamp(2rem,6vw,5rem)] font-bold tracking-tight text-white leading-[1.1]">
              Find your next camera.
            </h2>
            ...
            <p className="hidden md:block text-[11px] uppercase tracking-[0.25em] text-white/50 font-medium mt-10">
              You Happy, We Happy
            </p>
          </>
        )}
