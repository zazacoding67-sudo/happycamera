  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
      ...
      <div className="prose prose-sm prose-neutral max-w-none text-[#666] leading-relaxed space-y-4">
        ...
        <p>You may request deletion of your data at any time by contacting <a href="mailto:happycamerabusiness@gmail.com" className="underline underline-offset-2 text-[#1A1A1A]">happycamerabusiness@gmail.com</a>.</p>
